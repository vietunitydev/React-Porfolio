...
const ProjectCard = ({ project, onClick }) => {
    ...
    return (
        <div
            className={`${theme === 'dark' ? 'bg-gray-800/50' : 'bg-white'} backdrop-blur-sm rounded-xl overflow-hidden border ${theme === 'dark' ? 'border-gray-700/50 hover:border-purple-500/50' : 'border-gray-200 hover:border-purple-400'} transition-all duration-300 transform hover:scale-105 hover:shadow-2xl cursor-pointer group`}
            onClick={onClick}
        >
            ...
            <div className="p-6">
                ...
                <p className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} text-sm mb-4`}>{project.description}</p>
