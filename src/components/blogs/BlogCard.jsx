        ...
        <div className="relative mb-4 sm:mb-5">
            ...
            <div className="flex items-center gap-2 relative min-h-[2rem]">
                ...
                <div className="relative flex items-center z-10 flex-shrink-0">
                    <div className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full ${theme === 'dark' ? 'bg-gray-500' : 'bg-gray-400'}`} />
                    <div className={`w-0.5 h-8 sm:h-10 absolute top-2 sm:top-3 left-1/2 -translate-x-1/2 ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-300'}`} />
                </div>
